...
if __name__ == '__main__':
    global cid2hash
    hash_file_names = ["/apdcephfs_cq3/share_2973545/mingyyi/aigc/sogou_dataset/index_data_base/phash/" + str(i).zfill(5) + ".csv" for i in range(0,1160)]
    cid2hash = get_cid2hash(hash_file_names)
    ann_file_names = ["/apdcephfs_cq3/share_2973545/wenjieying/component/data/texts_vec_1107_show_1053_500_ann_2/text_" + str(i).zfill(5) + "_ann" for i in range(1,501)]
